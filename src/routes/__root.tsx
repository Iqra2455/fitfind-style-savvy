...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FitFind — AI Fashion Fit Assistant" },
      { name: "description", content: "Find perfectly fitting clothes from Amazon & Daraz with AI-powered size recommendations." },
      { property: "og:title", content: "FitFind — AI Fashion Fit Assistant" },
      { property: "og:description", content: "AI-powered size and style recommendations for shoppers in Pakistan and globally." },
